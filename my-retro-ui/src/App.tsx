...
function App() {
  ...
  return (
    <div style={{ width: "100%", background: "#181818ff", minHeight: "100vh",position:"relative" }}>
      <img src={logo} width={400} style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-70%)", filter:'invert(100%)'}}/>
      {!authinicated && <Login />}
